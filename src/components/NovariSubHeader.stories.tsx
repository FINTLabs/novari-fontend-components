...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: "A second header for the sub-pages that might need new navigation of their own. Looks" +
...
export const withChild: Story = {
    parameters: {
        docs: {
            description: {
                story: "The sub header is by default made up of two elements, the title and the menu, but You are" +
...
export const withNovariHeader: Story = {
    parameters: {
        docs: {
            description: {
                story: "Looks even better when it has the full width of a website. You are free to choose the width" +
