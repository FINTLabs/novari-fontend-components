...
const meta = {
    title: 'Components/NovariCircularProgressBar',
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A versatile component that shows progress and percentage of two values given. ' +
...
export const Default: Story = {
    parameters: {
        docs: {
            ...
            description: {
                story:
                    "These are the colors the component will default to if colors aren't specified:" +
...
export const Custom: Story = {
    parameters: {
        docs: {
            ...
            description: {
                story:
                    'You may of course choose any colors you see fit for your application, like for example the' +
